...
import (
	datastructurestypes "engine/modules/datastructures/internal/types"
	"slices"
...
func NewSparseSetWithPaging[Index constraints.Integer]() datastructurestypes.SparseSet[Index] {
	var zero Index
	pageSize := 4096
