...
BenchmarkClone1-8         	  572452	      2027 ns/op
BenchmarkClone2-8         	  521203	      2126 ns/op
BenchmarkManual1Clone-8   	55962079	        21.34 ns/op
BenchmarkManual2Clone-8   	42486403	        27.80 ns/op
PASS
ok  	engine/modules/prototype/test	4.662s
```
## Lines of code
```
