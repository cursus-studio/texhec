...
BenchmarkClone1-8         	  531890	      2085 ns/op
BenchmarkClone2-8         	  537548	      2191 ns/op
BenchmarkManual1Clone-8   	55182746	        21.52 ns/op
BenchmarkManual2Clone-8   	42673527	        27.69 ns/op
PASS
ok  	engine/modules/prototype/test	4.673s
```
## Lines of code
```
