...
BenchmarkClone1-8         	  482223	      2260 ns/op
BenchmarkClone2-8         	  514256	      2331 ns/op
BenchmarkManual1Clone-8   	36900560	        29.48 ns/op
BenchmarkManual2Clone-8   	33943478	        31.63 ns/op
PASS
ok  	engine/modules/prototype/test	4.514s
```
## Dependencies
`engine`:
  - `engine.EngineWorld`
