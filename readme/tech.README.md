...
This repository is public solely for recruitment, code review, and functionality demonstration purposes.
Permission is hereby granted to download and run this software locally on your own machine for the sole purpose of personal evaluation and previewing.
Prohibited:
* Commercial Use: You may not use this software, in whole or in part, for any commercial purposes or financial gain.
* Derivative Works: You may not modify, adapt, or use this code as a base to fork or create your own projects.
* Distribution: No part of this software may be reproduced, distributed, or transmitted in any form or by any means to third parties without prior written permission from the copyright holder.
